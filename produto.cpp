...
Produto::Produto(long long int id_produto, const char nome_produto[], float preco_produto, int quant_estoque)
{
...
void Produto::setId_produto(long long int id_produto)
{
    this->id_produto = id_produto;
}

long long int Produto::getId_produto()
{
    return id_produto;
}
